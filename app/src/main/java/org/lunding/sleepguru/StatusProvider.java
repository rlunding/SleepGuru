...
public class StatusProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionsArgs){
        ...
        switch (sURIMatcher.match(uri)){
            ...
            case StatusContract.STATUS_ITEM:
                ...
                break;
            default:
                throw new IllegalArgumentException("Illgal uri:" + uri);
        }

        SQLiteDatabase db = dbHelper.getWritableDatabase();
        int ret = db.delete(StatusContract.TABLE, where, selectionsArgs);
    ...
    //SELECT username, score, created_at FROM status WHERE user='Rasmus' ORDER
    //BY created_at DESC;
    @Override
